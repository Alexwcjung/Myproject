...
def check_target_grammar_sentence(target, sentence):
    ...
    if target == "make + 사람/대상 + 형용사/기본 행동 단어":
        ...
        if re.search(r"\b(make|makes|made)\s+(me|you|him|her|us|them|my\s+\w+|your\s+\w+|our\s+\w+|the\s+\w+|[a-z]+)\s+(?!to\b)\w+", low):
            return ok()
        return no("make + 사람/대상 + 형용사/기본 행동 단어 구조를 써 보세요. 예: You make me happy. / You make me smile.")
...
GRAMMAR_POINTS = {'1. Let It Go - Frozen OST': {'target': 'Let + 사람/대상 + 기본 행동 단어',
 ...
 '15. Counting Stars - OneRepublic': {'target': 'I have been + -ing 모양',
                                      ...
                                      'sentence_choices': ['studying English',
                                                           ...
                                                           'practicing singing'],
                                      'sentence_suffix': ''},
 '16. Fly to the Moon - Peder Elias': {'target': "can't + 기본 행동 단어",
                                       ...
                                       'meaning_answer': '~할 수 없다',
                                       'rule_answer': "can't + 기본 행동 단어 = ~할 수 없다",
                                       'rule_options': ["can't + 과거 모양 = 어제 ~했다",
                                                        "can't + ing = ~하는 중이다",
                                                        "can't + to + 행동 단어 = ~해야 한다",
                                                        "can't + 기본 행동 단어 = ~할 수 없다"],
                                       ...
                                       'sentence_choices': ['give up',
                                                            ...
                                                            'stop trying'],
                                       'sentence_suffix': ''},
 '17. My Universe - Coldplay X BTS': {'target': 'make + 사람/대상 + 형용사/기본 행동 단어',
                                      'examples': ['You make me happy.',
                                                   'You make me feel special.',
                                                   'This song makes me smile.',
                                                   'My friends make me excited.',
                                                   'You make my world bright.'],
                                      'frequent_options': ['I can', 'You are', 'make me', 'Let it'],
                                      'frequent_answer': 'make me',
                                      'form_options': ['make + 사람/대상 + to + 행동 단어',
                                                       'make + 사람/대상 + 과거 모양',
                                                       'make + 사람/대상 + will',
                                                       'make + 사람/대상 + 형용사/기본 행동 단어'],
                                      'form_answer': 'make + 사람/대상 + 형용사/기본 행동 단어',
                                      'meaning_examples': [('You make me happy.', '너는 나를 행복하게 해.'),
                                                           ('This song makes me smile.', '이 노래는 나를 웃게 해.'),
                                                           ('You make my world bright.', '너는 내 세상을 밝게 해.')],
                                      'meaning_options': ['~할 수 있다', '~하지 않을 것이다', '누군가를 ~하게 만들다', '~해야 한다'],
                                      'meaning_answer': '누군가를 ~하게 만들다',
                                      'rule_answer': 'make + 사람/대상 + 형용사/기본 행동 단어 = 누군가를 ~하게 만들다',
                                      'rule_options': ['make + 사람/대상 + to + 행동 단어 = ~할 수 있다',
                                                       'make + 사람/대상 + will = 앞으로 ~할 것이다',
                                                       'make + 사람/대상 + 과거 모양 = 어제 ~했다',
                                                       'make + 사람/대상 + 형용사/기본 행동 단어 = 누군가를 ~하게 만들다'],
                                      'practice': [('빈칸: You make me _____.',
                                                    ['happily', 'happy', 'happiness', 'happier than'],
                                                    'happy',
                                                    'make + 사람 + 형용사 구조입니다.'),
                                                   ('맞는 문장은?',
                                                    ['You make me to smile.',
                                                     ...
                                                     'You make me smile.'],
                                                    'You make me smile.',
                                                    'make + 사람 + 기본 행동 단어 구조입니다.'),
                                                   ('This song makes me smile.의 뜻은?',
                                                    ['이 노래는 나를 슬프게 해.', '이 노래는 나를 웃게 해.', '나는 이 노래를 만들었어.', '나는 이 노래를 들을 수 있어.'],
                                                    '이 노래는 나를 웃게 해.',
                                                    'make는 누군가를 어떤 상태나 행동으로 이끈다는 뜻입니다.'),
                                                   ('빈칸: My friends make me _____.',
                                                    ['excited', 'excitingly', 'to excite', 'excites'],
                                                    'excited',
                                                    'make + 사람 + 형용사 구조입니다.'),
                                                   ('알맞은 구조는?',
                                                    ['make + 사람/대상 + to + 행동 단어',
                                                     'make + 사람/대상 + 형용사/기본 행동 단어',
                                                     'make + 사람/대상 + will',
                                                     'make + 사람/대상 + 어려운 문법 모양'],
                                                    'make + 사람/대상 + 형용사/기본 행동 단어',
                                                    '누군가를 어떤 상태가 되게 하거나 어떤 행동을 하게 할 때 씁니다.')],
                                      'sentence_prefix': 'You make me',
                                      'sentence_choices': ['happy',
                                                           'smile',
                                                           'feel special',
                                                           'excited',
                                                           'try again'],
