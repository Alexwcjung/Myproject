...
GRAMMAR_POINTS = {'1. Let It Go - Frozen OST': {'target': 'Let + 사람/명사 + 동사',
 ...
 '20. Every Breath You Take - The Police': {'target': 'Every + 명사 + 주어 + 동사',
                                            ...
                                            'sentence_choices': ['word you say',
                                                                 ...
                                                                 'game you play'],
                                            'sentence_suffix': ''},
 '21. Forever Young - Alphaville': {'target': 'want to + 동사',
                                    'examples': ['I want to be forever young.',
                                                 'Do you really want to live forever?',
                                                 'We never say never.',
                                                 "Why don't they stay young?",
                                                 "I don't want to perish."],
                                    'frequent_options': ['want to', 'Every', "Let's", 'used to'],
                                    'frequent_answer': 'want to',
                                    'form_options': ['want to + 과거형',
                                                     'want to + 동사',
                                                     'want to + ing 형태',
                                                     'want to + 명사만'],
                                    'form_answer': 'want to + 동사',
                                    'meaning_examples': [('I want to be forever young.', '나는 영원히 젊고 싶어.'),
                                                         ('Do you really want to live forever?', '너는 정말 영원히 살고 싶니?'),
                                                         ("I don't want to perish.", '나는 사라지고 싶지 않아.')],
                                    'meaning_options': ['~하고 싶다', '~할 수 있다', '예전에 ~했다', '함께 ~하자'],
                                    'meaning_answer': '~하고 싶다',
                                    'rule_answer': 'want to + 동사 = ~하고 싶다',
                                    'rule_options': ['want to + 동사 = ~하고 싶다',
                                                     'want to + 과거형 = 어제 ~했다',
                                                     'want to + ing = ~하고 있는 중이다',
                                                     'want to + can = ~할 수 있다'],
                                    'practice': [('빈칸: I want to _____ forever young.',
                                                  ['am', 'was', 'be', 'being'],
                                                  'be',
                                                  'want to 뒤에는 동사가 옵니다.'),
                                                 ('맞는 문장은?',
                                                  ['I want to being forever young.',
                                                   'I want to be forever young.',
                                                   'I want be forever young.',
                                                   'I want to am forever young.'],
                                                  'I want to be forever young.',
                                                  'want to + 동사'),
                                                 ('Do you really want to live forever?의 뜻은?',
                                                  ['너는 정말 영원히 살고 싶니?', '너는 영원히 살았다.', '너는 젊어 보인다.', '너는 노래를 듣고 있다.'],
                                                  '너는 정말 영원히 살고 싶니?',
                                                  'want to live는 살고 싶다는 뜻입니다.'),
                                                 ("빈칸: I don't want to _____.",
                                                  ['perishes', 'perished', 'perish', 'perishing'],
                                                  'perish',
                                                  "don't want to + 동사"),
                                                 ('알맞은 구조는?',
                                                  ['want to + 과거형', 'want to + 동사', 'want to + ing', 'want to + will'],
                                                  'want to + 동사',
                                                  '하고 싶은 일을 말할 때 씁니다.')],
                                    'sentence_prefix': 'I want to',
                                    'sentence_choices': ['be happy',
                                                         'live freely',
                                                         'stay young',
                                                         'help my friends',
                                                         'follow my dream'],
...
SONGS = {'1. Let It Go - Frozen OST': {'video_url': 'https://www.youtube.com/watch?v=RgGRyssdJvw',
 ...
 '21. Forever Young - Alphaville': {'video_url': 'https://www.youtube.com/watch?v=G7ymMw9twbI&list=RDG7ymMw9twbI&start_radio=1',
                                    'lyrics': [("Let's dance in style, let's dance for a while", '멋지게 춤추자, 잠시 동안 춤추자'),
                                               ...
                                               ('Hoping for the best but expecting the worst', '최고를 바라지만 최악도 예상하면서'),
                                               ('Are you gonna drop the bomb or not?', '폭탄을 떨어뜨릴 건가요, 아닌가요?'),
                                               ('Let us die young or let us live forever',
                                                '우리를 젊은 채 죽게 하거나 영원히 살게 해 주세요'),
                                               ("We don't have the power but we never say never",
                                                '우리에겐 힘은 없지만 절대 불가능하다고 말하지 않아'),
                                               ('Sitting in a sandpit, life is a short trip',
                                                '모래 구덩이에 앉아, 인생은 짧은 여행이야'),
                                               ("The music's for the sad man", '이 음악은 슬픈 사람을 위한 거야'),
                                               ('Can you imagine when this race is won?', '이 경주가 끝났을 때를 상상할 수 있나요?'),
                                               ('Turn our golden faces into the sun', '우리의 빛나는 얼굴을 태양 쪽으로 돌려'),
                                               ("Praising our leaders, we're getting in tune",
                                                '지도자들을 칭송하며, 우리는 박자를 맞춰 가고 있어'),
                                               ("The music's played by the, the mad man", '그 음악은 미친 사람이 연주하고 있어'),
                                               ('Forever young, I want to be forever young', '영원히 젊게, 나는 영원히 젊고 싶어'),
                                               ('Do you really want to live forever?', '너는 정말 영원히 살고 싶니?'),
                                               ('Forever, and ever', '영원히, 또 영원히'),
                                               ('Forever young, I want to be forever young', '영원히 젊게, 나는 영원히 젊고 싶어'),
                                               ('Do you really want to live forever?', '너는 정말 영원히 살고 싶니?'),
                                               ('Forever young', '영원히 젊게'),
                                               ('Some are like water, some are like the heat',
                                                '어떤 사람은 물 같고, 어떤 사람은 열기 같아'),
                                               ('Some are a melody and some are the beat', '어떤 사람은 멜로디이고, 어떤 사람은 박자야'),
                                               ('Sooner or later, they all will be gone', '조만간 그들은 모두 사라질 거야'),
                                               ("Why don't they stay young?", '왜 그들은 젊은 채로 머물지 않을까?'),
                                               ("It's so hard to get old without a cause", '목표 없이 늙어 가는 것은 너무 힘들어'),
                                               ("I don't want to perish like a fading horse",
                                                '나는 희미해지는 말처럼 사라지고 싶지 않아'),
                                               ("Youth's like diamonds in the sun", '젊음은 햇빛 속의 다이아몬드 같아'),
                                               ('And diamonds are forever', '그리고 다이아몬드는 영원해')],
                                    'quiz': [{'q': '1. 이 노래에서 화자가 반복해서 바라는 것은 무엇인가요?',
                                              'options': ['forever young',
                                                          'forever alone',
                                                          'a new car',
                                                          'a long vacation'],
                                              'answer': 'forever young'},
                                             {'q': "2. 'Heaven can wait'의 의미로 가장 알맞은 것은?",
                                              'options': ['아직 죽음이나 끝을 생각하고 싶지 않다',
                                                          '하늘이 사라졌다',
                                                          '천국에 바로 가고 싶다',
                                                          '비가 올 것이다'],
                                              'answer': '아직 죽음이나 끝을 생각하고 싶지 않다'},
                                             {'q': "3. 'Hoping for the best but expecting the worst'는 어떤 태도를 보여 주나요?",
                                              'options': ['좋은 결과를 바라지만 나쁜 상황도 예상함', '항상 포기함', '아무 생각이 없음', '음악을 싫어함'],
                                              'answer': '좋은 결과를 바라지만 나쁜 상황도 예상함'},
                                             {'q': "4. 'life is a short trip'의 의미로 알맞은 것은?",
                                              'options': ['인생은 짧은 여행과 같다', '여행은 항상 길다', '인생은 멈춰 있다', '음악은 짧다'],
                                              'answer': '인생은 짧은 여행과 같다'},
                                             {'q': "5. 'Do you really want to live forever?'는 무엇을 묻고 있나요?",
                                              'options': ['정말 영원히 살고 싶은지', '정말 춤추고 싶은지', '정말 공부하고 싶은지', '정말 떠나고 싶은지'],
                                              'answer': '정말 영원히 살고 싶은지'},
                                             {'q': '6. 노래에서 젊음은 무엇에 비유되나요?',
                                              'options': ['diamonds in the sun',
                                                          'rain in the night',
                                                          'a broken clock',
                                                          'a cold room'],
                                              'answer': 'diamonds in the sun'},
                                             {'q': "7. 'Some are a melody and some are the beat'의 의미로 알맞은 것은?",
                                              'options': ['사람마다 다른 역할과 색깔이 있다',
                                                          '모두가 같은 노래를 부른다',
                                                          '음악이 멈췄다',
                                                          '박자는 중요하지 않다'],
                                              'answer': '사람마다 다른 역할과 색깔이 있다'},
                                             {'q': '8. 이 노래의 전체 분위기로 가장 알맞은 것은?',
                                              'options': ['젊음, 시간, 삶의 끝을 생각하는 분위기',
                                                          '가벼운 쇼핑 노래',
                                                          '운동 경기 응원가',
                                                          '학교 시험 안내'],
                                              'answer': '젊음, 시간, 삶의 끝을 생각하는 분위기'}],
                                    'key_expressions': [('dance in style', '멋지게 춤추다'),
                                                        ('for a while', '잠시 동안'),
                                                        ('hope for the best', '최고를 바라다'),
                                                        ('expect the worst', '최악을 예상하다'),
                                                        ('never say never', '절대 불가능하다고 말하지 않다'),
                                                        ('life is a short trip', '인생은 짧은 여행이다'),
                                                        ('forever young', '영원히 젊은'),
                                                        ('want to be', '~이 되고 싶다'),
                                                        ('sooner or later', '조만간'),
                                                        ('diamonds are forever', '다이아몬드는 영원하다')],
                                    'matching': [('Forever young', '영원히 젊게'),
                                                 ('I want to be forever young', '나는 영원히 젊고 싶어'),
                                                 ('Do you really want to live forever?', '너는 정말 영원히 살고 싶니?'),
                                                 ('We never say never', '우리는 절대 불가능하다고 말하지 않아'),
                                                 ('Life is a short trip', '인생은 짧은 여행이야'),
...
BACKGROUND_CONTENT = {'1. Let It Go - Frozen OST': {'title': '❄️ Let It Go: 숨겨 왔던 자신을 받아들이는 순간',
 ...
 '21. Forever Young - Alphaville': {'title': '💎 Forever Young: 젊음과 시간에 대해 생각하게 하는 노래',
                                    'paragraphs': ['Forever Young은 Alphaville의 대표곡으로, 젊음, 시간, 삶의 끝, 그리고 영원히 남고 싶은 마음을 '
                                                   '담은 노래입니다. 겉으로는 부드럽고 아름다운 멜로디의 노래처럼 들리지만, 가사를 자세히 보면 불안한 시대 속에서 젊음을 '
                                                   '붙잡고 싶은 마음이 드러납니다.',
                                                   '노래 속 화자는 Hoping for the best but expecting the worst라고 말합니다. 이는 좋은 '
                                                   '미래를 바라지만 동시에 나쁜 일이 일어날 수도 있다는 불안을 느끼는 태도를 보여 줍니다. Are you gonna '
                                                   'drop the bomb or not?이라는 표현은 당시의 전쟁과 불안한 사회 분위기를 떠올리게 합니다.',
                                                   '반복되는 Forever young, I want to be forever young은 단순히 나이를 먹고 싶지 않다는 '
                                                   '뜻만은 아닙니다. 순수함, 꿈, 열정, 소중한 순간을 오래 간직하고 싶은 마음으로 이해할 수 있습니다. Youth is '
                                                   'like diamonds in the sun이라는 표현도 젊음이 햇빛 속 다이아몬드처럼 빛나고 귀하다는 이미지를 보여 '
                                                   '줍니다.',
                                                   '수업에서는 forever young, for a while, hope for the best, expect the '
                                                   'worst, never say never, life is a short trip, want to be, sooner '
                                                   'or later, stay young, diamonds are forever 같은 표현을 중심으로 배울 수 있습니다. '
                                                   '학생들은 시간이 지나도 지키고 싶은 마음, 꿈, 나다운 모습에 대해 생각을 적을 수 있습니다.']}}
