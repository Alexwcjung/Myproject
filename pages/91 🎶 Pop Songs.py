...
GRAMMAR_POINTS = {'1. Let It Go - Frozen OST': {'target': 'Let + 사람/명사 + 동사',
 ...
 '20. Honeymoon - Johnny Stimson': {'target': "won't + 동사",
                                    'examples': ["Honey, I won't ever let go.",
                                                 "I won't ever leave you.",
                                                 "I won't forget this moment.",
                                                 "I won't stop dancing.",
                                                 "I won't give up on you."],
                                    'frequent_options': ['I can', "I won't", 'I used to', "Let's"],
                                    'frequent_answer': "I won't",
                                    'form_options': ["won't + 과거형",
                                                     "won't + to + 동사",
                                                     "won't + -ing 형태",
                                                     "won't + 동사"],
                                    'form_answer': "won't + 동사",
                                    'meaning_examples': [("I won't ever let go.", '나는 절대 놓지 않을 거야.'),
                                                         ("I won't forget this moment.", '나는 이 순간을 잊지 않을 거야.'),
                                                         ("I won't give up on you.", '나는 너를 포기하지 않을 거야.')],
                                    'meaning_options': ['~할 수 있다', '~하지 않을 것이다', '예전에 ~하곤 했다', '함께 ~하자'],
                                    'meaning_answer': '~하지 않을 것이다',
                                    'rule_answer': "won't + 동사 = ~하지 않을 것이다",
                                    'rule_options': ["won't + 과거형 = 어제 ~하지 않았다",
                                                     "won't + to + 동사 = ~할 수 있다",
                                                     "won't + ing = ~하고 있는 중이다",
                                                     "won't + 동사 = ~하지 않을 것이다"],
                                    'practice': [("빈칸: I won't ever _____ go.",
                                                  ['lets', 'let', 'letting', 'to let'],
                                                  'let',
                                                  "won't 뒤에는 동사가 옵니다."),
                                                 ('맞는 문장은?',
                                                  ["I won't to leave you.",
                                                   "I won't leaving you.",
                                                   "I won't leave you.",
                                                   "I won't left you."],
                                                  "I won't leave you.",
                                                  "won't + 동사"),
                                                 ("I won't forget this moment.의 뜻은?",
                                                  ['나는 이 순간을 잊지 않을 거야.', '나는 이 순간을 잊었다.', '나는 이 순간을 기억할 수 있다.', '나는 이 순간을 기다리고 있다.'],
                                                  '나는 이 순간을 잊지 않을 거야.',
                                                  "won't는 미래에 하지 않겠다는 뜻입니다."),
                                                 ("빈칸: I won't _____ dancing.",
                                                 ...
                                                 ('알맞은 규칙은?',
                                                  ["won't 뒤에는 동사를 바로 쓴다",
                                                   "won't 뒤에는 항상 to를 쓴다",
                                                   "won't 뒤에는 항상 과거형만 쓴다",
                                                   "won't는 예전 습관을 말한다"],
                                                  "won't 뒤에는 동사를 바로 쓴다",
                                                  "I won't ever let go.를 보면 won't 뒤에 let이 바로 옵니다.")],
                                    'sentence_prefix': "I won't",
                                    'sentence_choices': ['let go',
                                                         'forget you',
                                                         'give up',
                                                         'stop dancing',
                                                         'leave you'],
...
SONGS = {'1. Let It Go - Frozen OST': {'video_url': 'https://www.youtube.com/watch?v=RgGRyssdJvw',
 ...
 '20. Honeymoon - Johnny Stimson': {'video_url': '',
                                    'lyrics': [('I live a lifetime every moment', '나는 매 순간 한평생을 사는 것 같아'),
                                               ("When I'm holding you close", '내가 너를 가까이 안고 있을 때'),
                                               ('Lay your head down on my shoulder', '내 어깨에 네 머리를 기대'),
                                               ("Honey, I won't ever let go", '사랑아, 나는 절대 놓지 않을 거야'),
                                               ('Because you pulled me like a magnet', '왜냐하면 너는 자석처럼 나를 끌어당겼으니까'),
                                               ("Now, I'm right where I belong", '이제 나는 내가 있어야 할 바로 그곳에 있어'),
                                               ("I'm gonna love you the same for the rest of my days", '남은 날들 동안 나는 변함없이 너를 사랑할 거야'),
                                               ('And on, and on, and on', '계속, 계속, 계속'),
                                               ("'Cause as long as we keep dancing", '우리가 계속 춤추는 한'),
                                               ("We'll stay young at heart", '우리는 마음만은 젊게 남을 거야'),
                                               ('And every time I hold you in my arms', '그리고 내가 너를 품에 안을 때마다'),
                                               ('You give me deja vu', '너는 나에게 데자뷔 같은 느낌을 줘'),
                                               ("Like I've been waiting my whole life to find that view", '마치 그 풍경을 찾기 위해 평생 기다려 온 것처럼'),
                                               ("'Cause when I'm lookin' at your eyes", '왜냐하면 내가 네 눈을 바라볼 때'),
                                               ('I go from California to Timbuktu', '나는 캘리포니아에서 팀북투까지 가는 것 같아'),
                                               ('Back to dancing in the living room', '다시 거실에서 춤추는 순간으로 돌아와'),
                                               ("If I got you, baby, everyday's a honeymoon", '네가 있다면, 매일이 신혼여행 같아'),
                                               ("Oh-oh, it's a honeymoon", '오, 신혼여행 같아'),
                                               ("Baby, everyday's a honeymoon", '사랑아, 매일이 신혼여행 같아'),
                                               ('I wanna spend some time in Paris', '나는 파리에서 시간을 좀 보내고 싶어'),
                                               ('Serenade you on the beach', '해변에서 너에게 세레나데를 불러 주고 싶어'),
                                               ("We'll take a picture for our parents", '우리는 부모님을 위해 사진을 찍을 거야'),
                                               ("But we're never gonna leave", '하지만 우리는 절대 떠나지 않을 거야'),
                                               ('Nobody knows you like I know you', '아무도 내가 너를 아는 것처럼 너를 알지 못해'),
                                               ('Nobody loves you like I do', '아무도 내가 사랑하는 것처럼 너를 사랑하지 못해'),
                                               ("And if I'm never a star, but I've got my guitar", '내가 스타가 되지 못하더라도, 기타가 있다면'),
                                               ("I'll be singing songs to you", '나는 너에게 노래를 불러 줄 거야'),
                                               ("'Cause as long as we keep dancing", '우리가 계속 춤추는 한'),
                                               ("We'll stay young at heart", '우리는 마음만은 젊게 남을 거야'),
                                               ('And every time I hold you in my arms', '그리고 내가 너를 품에 안을 때마다'),
                                               ('You give me deja vu', '너는 나에게 데자뷔 같은 느낌을 줘'),
                                               ...
                                               ("Oh-oh, it's a honeymoon", '오, 신혼여행 같아'),
                                               ("Baby, everyday's a honeymoon", '사랑아, 매일이 신혼여행 같아'),
                                               ("Maybe we'll end up in New York City", '어쩌면 우리는 결국 뉴욕시에 가게 될지도 몰라'),
                                               ("Maybe we'll end up out in L.A.", '어쩌면 우리는 결국 LA에 가게 될지도 몰라'),
                                               ("Maybe we'll decide to stay right here forever after", '어쩌면 우리는 바로 여기서 영원히 머물기로 할지도 몰라'),
                                               ('I will love you all the same', '그래도 나는 똑같이 너를 사랑할 거야'),
                                               ('You give me deja vu', '너는 나에게 데자뷔 같은 느낌을 줘'),
                                               ("Like I've been waiting my whole life to find that view", '마치 그 풍경을 찾기 위해 평생 기다려 온 것처럼'),
                                               ("'Cause when I'm lookin' at your eyes", '왜냐하면 내가 네 눈을 바라볼 때'),
                                               ('I go from California to Timbuktu', '나는 캘리포니아에서 팀북투까지 가는 것 같아'),
                                               ...
                                               ("If I got you, baby, everyday's a honeymoon", '네가 있다면, 매일이 신혼여행 같아'),
                                               ('Oh-oh-oh', '오-oh-oh'),
                                               ("Oh, it's a honeymoon", '오, 신혼여행 같아'),
                                               ('Oh-oh-oh', '오-oh-oh'),
                                               ("Baby, everyday's a honeymoon with you", '사랑아, 너와 함께라면 매일이 신혼여행 같아'),
                                               ('Oh-oh-oh', '오-oh-oh'),
                                               ("Oh, it's a honeymoon", '오, 신혼여행 같아'),
                                               ("If I got you, baby, everyday's a honeymoon", '네가 있다면, 매일이 신혼여행 같아')],
                                    'quiz': [{'q': '1. 이 노래에서 화자는 상대와 함께 있을 때 어떤 느낌을 받나요?',
                                              'options': ['매 순간이 특별하고 평생 같은 느낌을 받는다', '항상 혼자 있고 싶어 한다', '상대와 멀리 떠나고 싶어 한다', '춤추는 것을 싫어한다'],
                                              'answer': '매 순간이 특별하고 평생 같은 느낌을 받는다'},
                                             {'q': "2. 'I won't ever let go'의 의미로 알맞은 것은?",
                                              'options': ['절대 놓지 않겠다는 뜻', '곧 떠나겠다는 뜻', '잠시 쉬겠다는 뜻', '혼자 춤추겠다는 뜻'],
                                              'answer': '절대 놓지 않겠다는 뜻'},
                                             {'q': "3. 'You pulled me like a magnet'이 보여 주는 감정은?",
                                              'options': ['강하게 끌리는 마음', '무서워서 도망가는 마음', '아무 관심이 없는 마음', '화가 난 마음'],
                                              'answer': '강하게 끌리는 마음'},
                                             {'q': "4. 'as long as we keep dancing'의 뜻으로 알맞은 것은?",
                                              'options': ['우리가 계속 춤추는 한', '우리가 춤을 멈췄기 때문에', '우리가 여행을 포기하면', '우리가 서로를 잊는다면'],
                                              'answer': '우리가 계속 춤추는 한'},
                                             {'q': "5. 'young at heart'의 의미로 알맞은 것은?",
                                              'options': ['마음이 젊은', '몸이 아픈', '나이가 아주 어린', '마음이 차가운'],
                                              'answer': '마음이 젊은'},
                                             {'q': '6. 화자는 어디에서 시간을 보내고 싶다고 말하나요?',
                                              'options': ['Paris와 beach', 'school와 library', 'hospital와 station', 'market와 airport'],
                                              'answer': 'Paris와 beach'},
                                             {'q': '7. 화자가 스타가 되지 못해도 하겠다고 말한 것은?',
                                              'options': ['기타를 들고 상대에게 노래를 불러 주기', '상대를 떠나기', '혼자 사진을 찍기', '노래를 완전히 그만두기'],
                                              'answer': '기타를 들고 상대에게 노래를 불러 주기'},
                                             {'q': '8. 이 노래의 중심 메시지로 가장 알맞은 것은?',
                                              'options': ['사랑하는 사람과 함께라면 평범한 하루도 특별해진다', '여행은 항상 혼자 가야 한다', '유명해지는 것이 가장 중요하다', '사랑보다 장소가 더 중요하다'],
                                              'answer': '사랑하는 사람과 함께라면 평범한 하루도 특별해진다'}],
                                    'key_expressions': [('hold you close', '너를 가까이 안다'),
                                                        ("won't ever let go", '절대 놓지 않을 거야'),
                                                        ('like a magnet', '자석처럼'),
                                                        ('where I belong', '내가 있어야 할 곳'),
                                                        ('for the rest of my days', '남은 날들 동안'),
                                                        ('as long as', '~하는 한'),
                                                        ('young at heart', '마음이 젊은'),
                                                        ('deja vu', '데자뷔 / 전에 본 듯한 느낌'),
                                                        ('spend some time', '시간을 보내다'),
                                                        ('all the same', '그래도 똑같이')],
                                    'matching': [("won't ever let go", '절대 놓지 않을 거야'),
                                                 ('like a magnet', '자석처럼'),
                                                 ('where I belong', '내가 있어야 할 곳'),
                                                 ('as long as', '~하는 한'),
                                                 ('young at heart', '마음이 젊은'),
                                                 ('everyday is a honeymoon', '매일이 신혼여행 같아')],
                                    'reflect_questions': ['나에게 평범한 하루를 특별하게 만들어 주는 사람이나 순간은 무엇인가요?',
                                                          '내가 오래도록 지키고 싶은 관계나 약속이 있다면 무엇인가요?',
                                                          '노래 속 honeymoon처럼 내가 꿈꾸는 행복한 장면은 어떤 모습인가요?']}}
...
BACKGROUND_CONTENT = {'1. Let It Go - Frozen OST': {'title': '❄️ Let It Go: 숨겨 왔던 자신을 받아들이는 순간',
 ...
 '20. Honeymoon - Johnny Stimson': {'title': '💍 Honeymoon: 함께라면 매일이 특별해지는 노래',
                                    'paragraphs': ['Honeymoon은 사랑하는 사람과 함께하는 평범한 순간이 특별한 여행처럼 느껴진다는 마음을 담은 노래입니다. 화자는 상대를 가까이 안고 있을 때 매 순간이 한평생처럼 크게 느껴진다고 말합니다.',
                                                   "Honey, I won't ever let go와 I'm gonna love you the same for the rest of my days는 상대를 오래도록 사랑하고 지키겠다는 약속을 보여 줍니다. pulled me like a magnet은 상대에게 강하게 끌리는 마음을 쉽게 이해할 수 있게 하는 표현입니다.",
                                                   '노래에는 California, Timbuktu, Paris, New York City, L.A.처럼 여러 장소가 나오지만, 핵심은 장소 자체가 아니라 함께 있는 사람입니다. 그래서 거실에서 춤추는 평범한 순간도 honeymoon처럼 특별하게 느껴집니다.',
                                                   "수업에서는 hold you close, won't ever let go, like a magnet, where I belong, as long as, young at heart, deja vu, every day is a honeymoon 같은 표현을 중심으로 배울 수 있습니다. 학생들은 평범한 하루를 특별하게 만드는 사람, 지키고 싶은 약속, 내가 꿈꾸는 행복한 장면을 생각해 볼 수 있습니다."]}}
